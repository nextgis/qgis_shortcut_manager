...
class Ui_CreateShortcutWizard(object):
    def setupUi(self, CreateShortcutWizard):
        ...
        sizePolicy.setHeightForWidth(
            CreateShortcutWizard.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.wizardPage1.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self._shortcutIcon.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self._chooseIcon_Btn.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, CreateShortcutWizard):
        ...
        CreateShortcutWizard.setWindowTitle(
            _translate("CreateShortcutWizard", "Create shortcut")
        )
        self.label_3.setText(
            _translate(
                "CreateShortcutWizard",
                "For what element it is necessary to create a shortcut?",
            )
        )
        self.label.setText(
            _translate("CreateShortcutWizard", "Enter element placement:")
        )
        self._changeShortcutURI_Btn.setText(
            _translate("CreateShortcutWizard", "Browse...")
        )
        self.label_2.setText(
            _translate("CreateShortcutWizard", "How to call a shortcut?")
        )
        self.label_4.setText(
            _translate("CreateShortcutWizard", "Enter shortcut name:")
        )
        self.label_5.setText(
            _translate(
                "CreateShortcutWizard", "What icon the shortcut has to have?"
            )
        )
        self.label_7.setText(
            _translate(
                "CreateShortcutWizard",
                "Icon by default the specified element:",
            )
        )
        self._chooseIcon_Btn.setText(
            _translate("CreateShortcutWizard", "Choose another...")
        )
